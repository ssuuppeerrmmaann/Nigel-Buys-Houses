// FILE: IndianaPage.tsx
// TITLE: Indiana Market Localized Landing Page
...
export default function IndianaPage() {
  ...
  // Indiana Pre-sets
  const [activeStateAbbr, setActiveStateAbbr] = useState('IN');
  const [activeStateRecord, setActiveStateRecord] = useState(STATE_RECORDS.find(s => s.abbr === 'IN')!);
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans transition-colors duration-300">
      ...
      <div id="sticky-callout" className="bg-[#ff7043] text-white py-3 px-5 text-center text-sm md:text-base font-bold tracking-wide shadow-sm z-50">
        ...
        Indiana coverage update: We currently buy in <strong className="font-bold underline text-white">Marion & Surrounding Counties</strong>! Avoid commission fees by about 10%
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden sm:flex flex-col text-right">
              <span className="text-[10px] text-[#868c92] font-bold uppercase tracking-wider">Talk to an Indiana Coordinator</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black font-serif leading-tight">
              Sell Your Indiana House <span className="text-[#ff7043]">Fast On Your Terms</span>. No Headaches.
            </h1>
                ...
                <div className="space-y-3.5 pt-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input type="text" value={city} onChange={(e) => setCity(e.target.value)} placeholder="Indianapolis" className="w-full px-3 py-2.5 border-2 border-slate-200 rounded-lg text-sm focus:border-[#ff7043] focus:outline-none" />
                    </div>
                    <div>
                      ...
                      <input type="text" value={zipCode} onChange={(e) => setZipCode(e.target.value)} placeholder="46201" className="w-full px-3 py-2.5 border-2 border-slate-200 rounded-lg text-sm focus:border-[#ff7043] focus:outline-none" />
                    </div>
                  </div>
      ...
      <footer className="bg-white border-t border-[#ced1d5]/40 py-16 text-slate-600 text-xs md:text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-10">
          <div className="md:col-span-8 space-y-4">
            <div className="flex items-center space-x-2.5">
              <img src="https://raw.githubusercontent.com/ssuuppeerrmmaann/Nigel-Buys-Houses/refs/heads/main/assets/images/nigel_buys_houses_transparent.png" alt="Nigel Buys Houses Logo" className="h-8 w-auto object-contain" referrerPolicy="no-referrer" />
